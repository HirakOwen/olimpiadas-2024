...
<!--End Header_Prod-->
    ...
    <div class="container mt-4">
      <div class="row gx-4 gy-4" id="productList">
        <!-- Example Product -->
        <div class="col-12 col-md-6" data-category="Ropa Deportiva" data-price="1500">
          <div class="p-2 h-100">
            ...
            <div class="card-body d-flex flex-column justify-content-between">
              ...
              <div class="d-flex justify-content-between align-items-center mt-3">
                ...
                <div class="d-flex gap-2">
                  <button class="btn p-0 save-btn"><img src="imgs/guardado.png" alt="Guardar" /></button>
                  <button class="btn p-0"><img src="imgs/Quitar.png" alt="Restar" /></button>

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-08-2024 a las 17:21:08
...
CREATE TABLE `domicilios` (
  `id_domicilios` int(100) NOT NULL,
  `domiclio` text NOT NULL,
...
--
ALTER TABLE `domicilios`
  MODIFY `id_domicilios` int(100) NOT NULL AUTO_INCREMENT;
